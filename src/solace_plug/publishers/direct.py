...
class DirectPublisher:
    ...
    def start(self):
        ...
        try:
            self._publisher = self._service.create_direct_message_publisher_builder().build()
            self._publisher.set_publish_failure_listener(_PublishFailureListener(self._on_failure))
    ...
    def publish(
        ...
        try:
            ...
            log.info(
                ...
                event.id, topic, msg_id, merged_props or "{}"
            )
